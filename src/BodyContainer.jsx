...
function BodyContainer(props){
  ...
  return (
    ...
    <div class="row">
    <Link to="/kombuchaDetails"><div class="card-image waves-effect waves-block waves-light col s4" onClick={props.currentKombucha} data-id="one"><img class="activator" alt="clear mind" src={ClearMindSmSq}/> </div>
    </Link>
